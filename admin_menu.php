    ...
    <div class="menu-grid" id="menuGrid">
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="menu-card" data-name="<?= strtolower($row['name']) ?>"
                    ...
                    <div class="admin-actions">
                        <button class="admin-edit-btn"
                            onclick="window.location.href='admin_edit_menu.php?id=<?= $row['menu_id'] ?>'">Edit</button>
                        <button class="admin-delete-btn delete"
                            onclick="if(confirm('Delete this item?')) window.location.href='admin_product_action.php?id=<?= $row['menu_id'] ?>'">Delete</button>
                    </div>
                    ...
                    <div class="stock-control">
                        ...
                        <button class="add" onclick="updateStock(<?= $row['menu_id'] ?>,'add')">+</button>
                    </div>
